...
public class RecentAssignmentViewCreator extends RecyclerView.Adapter<RecentAssignmentViewCreator.ViewHolder>
{
    ...
    public void update(String title ,String teachername,String duedate,String givendate,String assignmentid,String assignmenturl)
    {
        titles.add(title);
    ...
    public RecentAssignmentViewCreator(RecyclerView recyclerView, Context context, ArrayList<String> titles, ArrayList<String> teachernames, ArrayList<String> duedates, ArrayList<String> givendates,ArrayList<String> assignmenturls,ArrayList<String>assignmentids)
    {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position)
    {
        ...
        holder.Sender.setText(teachernames.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(final View itemView)        // represents indiv list items
        {
            ...
            button = (Button)itemView.findViewById(R.id.removebtn);
        }
    }
}