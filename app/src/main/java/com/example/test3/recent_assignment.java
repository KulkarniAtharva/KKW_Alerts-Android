    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s)
            {
                ...
                ((RecentAssignmentViewCreator)recyclerView.getAdapter()).update(title,teacher_name,due_date,given_date,assignment_id,assign_url);
        ...
        RecentAssignmentViewCreator myAdapter = new RecentAssignmentViewCreator(recyclerView, recent_assignment.this, new ArrayList<String>(), new ArrayList<String>(),new ArrayList<String>(),new ArrayList<String>(),new ArrayList<String>(),new ArrayList<String>());
